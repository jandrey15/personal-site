  ...
  return (
    <Layout {...SEO}>
      ...
      <section id='Home' className='container'>
        <div className='main'>
          <h2>Sobre mí</h2>
          <p>¡Hola! Mi nombre es John Andrey Serrano. Nací en Cúcuta - Colombia tengo 26 años actualmente me dedico al <Link prefetch href='/tag?slug=desarrollo-web' as='/tags/desarrollo-web'><a>Desarrollo web</a></Link> un apasionado y entusiasta de las tecnología web: JavaScript, Node.js, Docker, Firebase, React, etc.. En constante proceso de aprendizaje sobre todas las nuevas tecnologías, me gusta estar informado de lo que pasa en la web, ver cursos, leer artículos, ver tutoriales y tratar de compartir mis conocimientos a través de mi <Link prefetch href='/blog'><a>blog</a></Link>.</p>
